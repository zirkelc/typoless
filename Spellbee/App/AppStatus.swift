...
enum AppStatus: Equatable {
    ...
    var label: String {
        switch self {
        case .idle: return "Spellbee is ready"
        case .working: return "Spellbee is correcting"
        case .paused: return "Spellbee is paused"
        case .needsAttention: return "Spellbee needs setup"
