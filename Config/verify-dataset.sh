...
# type without the scorer ever needing one.
echo 'enum LocalModel: String, Equatable, Sendable { case placeholder }' > "$SOURCE"
...
cat \
    ...
    Spellbee/Engine/AppSettings.swift \
    Spellbee/Engine/CorrectionLanguage.swift \
    >> "$SOURCE"
